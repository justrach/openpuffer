...
| E027 | 2026-08-25 | AVX-512 VNNI `vpdpbusd` for `dotI8` (one zmm acc; signed via XOR-0x80 + 128*sum(b) correction). Not AMX — tile setup loses on a single 1536-d vector. Keep E013 64-lane fallback. | pending | src/vector.zig | pending | — | — | — | running | engine | control pair on current main: 0.493 / 0.465 ms, recall 0.3105. Historical E022 0.575 is stale-slow on this flatten tree; compare vs fresh control. |
