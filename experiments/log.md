...
| E008 | 2026-08-23 | reuse candidate/result heaps across searchLayer calls instead of allocating two PriorityQueues per layer | scratch heaps owned by searchAdvanced, reset per layer | src/hnsw.zig | pass | 0.615 / 0.650 | 0.3130 | -0.2% / +5.5% | discard | arena-backed bench alloc already makes queue alloc cheap; no 4% win. Reverted |
| E009 | 2026-08-23 | 64-byte-align quantized vectors so AVX-512 i8 loads are aligned | alignedAlloc(i8, 64) on insert | src/hnsw.zig | pending | — | — | — | running | vs host best 0.616ms |
