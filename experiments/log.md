...
| E006 | 2026-08-23 | stack-allocate 1536-dim query/quantize scratch (norm_buf/qbuf are 512, so every metric query heap-allocs) | grow searchAdvanced scratch from 512 to 2048 | src/hnsw.zig | pending | — | — | — | running | vs host best 0.834ms |
